package com.ezpnix.oracleswift.presentation.screens.settings.settings
...
import com.ezpnix.oracleswift.presentation.screens.settings.SettingsScaffold
...
import com.ezpnix.oracleswift.presentation.screens.settings.widgets.ListDialog
        ...
        LazyColumn {
            ...
            item {
                SettingsBox(
                    ...
                    radius = shapeManager(isFirst = true, radius = settingsViewModel.settings.value.cornerRadius),
                    linkClicked = { uriHandler.openUri("https://ezpnix.wordpress.com") }
                )
            }
            item {
                SettingsBox(
